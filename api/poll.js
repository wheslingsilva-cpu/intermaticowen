...
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = useOffset
      ? `https://api.telegram.org/bot${TOKEN}/getUpdates?offset=${useOffset}&timeout=0&allowed_updates=["callback_query","message"]`
      : `https://api.telegram.org/bot${TOKEN}/getUpdates?timeout=0&allowed_updates=["callback_query","message"]`;
